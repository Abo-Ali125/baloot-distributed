...
# event timestamp counter to avoid collisions when events fire quickly
_event_counter = 0
_counter_lock = Lock()
...
def poll_events():
    try:
        ...
        with events_lock:
            ...
            # get all events after the timestamp client has seen
    ...
    try:
        ...
        if len(room.game.current_trick) == 4:
            ...
            try:
                ...
                # Check if adding current round scores would make a team win (stops Team from playing tricks after hitting 152)
